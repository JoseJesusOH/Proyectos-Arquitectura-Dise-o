...
/**
 * Vista de nuestro programa Utilizamos la libreria swing
 *
 * @author fon
 */
public class Vista extends JFrame implements ModeloObserver {
    ...
    /**
     * Metodo de la interfaz del observador. Este método será llamado por el
     * Observable para que cada observador sepa qué ha pasado respecto al valor
     * cambiado.
     *
