...
public class Cliente implements Runnable{
    ...
    // Declaramos las variables para la conexion y comunicacion
    ...
    /*
     En este espacio se pondra la direccion ip para jugar en varias computadoras
     pero mientras sea en la misma se mantendra en el localhost
    */
    ...
    // Constructor que recibe como parametro la ventana, para poder hacer modificaciones en los botones
